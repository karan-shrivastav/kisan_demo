...
IncompleteLoanCubitModel incompleteLoanCubitModelFromJson(String str) =>
    IncompleteLoanCubitModel.fromJson(json.decode(str));

String incompleteLoanCubitModelToJson(IncompleteLoanCubitModel data) =>
    json.encode(data.toJson());

class IncompleteLoanCubitModel {
  String? stateName;
  int? stateId;
  String? districtName;
  int? districtId;
  ...
  IncompleteLoanCubitModel copyWith({
    String? stateName,
    int? stateId,
    String? districtName,
    int? districtId,
    ...
    List<CropDetailDto>? cropDetailDto,
      ...
      IncompleteLoanCubitModel(
          ...
          cropDetailDto: cropDetailDto ?? this.cropDetailDto,
      );

  factory IncompleteLoanCubitModel.fromJson(Map<String, dynamic> json) =>
      IncompleteLoanCubitModel(
        ...
        cropDetailDto: json["cropDetailDtos"],
      );
