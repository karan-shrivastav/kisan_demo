...
class AddParticularsOfMovableWidget extends StatefulWidget {
  const AddParticularsOfMovableWidget({super.key});

  @override
  State<AddParticularsOfMovableWidget> createState() =>
      _AddParticularsOfMovableWidgetState();
}

class _AddParticularsOfMovableWidgetState
    extends State<AddParticularsOfMovableWidget> {
