...
import 'package:ekisan_credit/cubit/apply_laon/add_crop_cubit.dart';
...
import 'package:ekisan_credit/view/loan_apply/screen/add_crop_screen.dart';
...
class CropLoanFromCropDetailsScreen extends StatefulWidget {
  static const routeName = "crop-loan-form-crop-details";

  const CropLoanFromCropDetailsScreen({super.key});

  @override
  State<CropLoanFromCropDetailsScreen> createState() =>
      _CropLoanFromCropDetailsScreenState();
}

class _CropLoanFromCropDetailsScreenState
    extends State<CropLoanFromCropDetailsScreen> {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      context.read<AddCropCubit>().clearData();
                      context
                                  ...
                                  return InkWell(
                                    ...
                                    child: ListTile(
                                      ...
                                      subtitle: AppTextWidget(
                                        text: crops[index].croppingSeasonName ??
                                            '',
                                ...
                                builder: (BuildContext context,
                                  ...
                                  return InkWell(
                                    onTap: () async {
                                      ...
                                      final applyLoanInfoCubit = context
                                          .read<ApplyLoanInfoCubit>()
                                          .state;
                                      ...
                                      final requestBody = {
                                        "loanMasterRequestPayload": {
                                          ...
                                          "covered": applyLoanInfoCubit.covered,
                                          "bankMasterId":
                                              applyLoanInfoCubit.bankMasterId,
                                          "entityLevelId":
                                              applyLoanInfoCubit.branchId,
                                          "stateId": applyLoanInfoCubit.stateId,
                                          "districtId":
                                              applyLoanInfoCubit.districtId,
                                          // "pacsLevelId": packsBankName.contains("Co-Operative")
                                          //     ? _selectedPacs!.id
                                          //     : null
                                          "pacsLevelId":
                                              applyLoanInfoCubit.pacsLevelId
                                        },
                                        if (saveCropNewState
                                            is SaveCropNewSuccess)
                                          "userProposedDetails": [
                                ...
                                listener: (BuildContext context,
                                  ...
                                  if (state is SaveCropNewSuccess) {
                                    ...
                                    loanPurposeCubit.updateModel(
                                      ...
                                      totalLandAreaUnitId: state
                                          .saveCropResponseModel
                                          .data!.userProposedDetails?.first.areaUnitId.toString()
