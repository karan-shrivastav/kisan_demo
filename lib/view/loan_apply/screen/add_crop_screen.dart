                  ...
                  children: [
                                        ...
                                        children: [
                                          Padding(
                                            padding: EdgeInsets.only(
                                                top: 5, left: 16),
                                            child: AppTextWidget(
                                              text: AppLocalizations.of(context)!.pleaseSelectLandType,
                                              fontSize: 12,
                    ...
                    BlocBuilder<CropNameNewBloc, CropNameNewState>(
                      builder: (BuildContext context, CropNameNewState state) {
                        ...
                        return  CommonTextField(labelText: AppLocalizations.of(context)!.crop);
                      },
                    ),
                    /********* Area Unit **********/
                    const SizedBox(
                            ...
                            child:
                              ...
                              builder: (BuildContext context,
                                ...
                                if (state.landTypeId != null &&
                                    ...
                                    state.areaUnitId != null &&  state.landSize != null && state.landSize!.isNotEmpty) {
                                  return InkWell(
                                    onTap: () {
                                      final kccLimitCubit =
