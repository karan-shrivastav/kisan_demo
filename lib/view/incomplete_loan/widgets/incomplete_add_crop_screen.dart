...
class IncompleteAddCropScreen extends StatefulWidget {
  ...
  @override
  State<IncompleteAddCropScreen> createState() =>
      _IncompleteAddCropScreenState();
}
                        ...
                        if (state is GetLovsTypeDataSuccess) {
                          ...
                          return CommonTypeAheadField<String>(
                            ...
                            onSelected: (selectedCroppingSeason) {
                              ...
                              croppingSeasonId = croppingSeason?[0].id ?? 0;
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: BlocConsumer<IncompleteLoanInfoCubit,
                                    IncompleteLoanCubitModel>(
                                builder: (BuildContext context,
                                    IncompleteLoanCubitModel state) {
                              {
                                return InkWell(
                                  onTap: () {
                                    final kccLimitCubit =
                                    ...
                                    incompleteLoanInfoCubit.state.cropDetailDto?.clear();
                                    ...
                                    incompleteLoanInfoCubit.state.cropDetailDto
                                      ...
                                      CropDetailDto(
                                          id: null,
                                          landTypeId:
                                              addCropInObject.state.landTypeId,
                                          landType: addCropInObject
                                              .state.landTypeName,
                                          croppingSeasonId: int.parse(
                                              '${addCropInObject.state.croppingSeasonId}'),
                                          croppingSeasonName: addCropInObject
                                              .state.croppingSeasonName,
                                          // cropId:
                                          // addCropInObject.state.cropId,
                                          areaUnitValue: addCropInObject
                                              .state.areaUnitName,
                                          areaUnitId: int.parse(
                                              '${addCropInObject.state.areaUnitId}'),
                                          cropName:
                                              addCropInObject.state.cropName,
                                          acreAmount:
                                              '${addCropInObject.state.mainAmount}',
                                          areaInAcre:
                                    ...
                                    for (int i = 0; i < 5; i++) {
                                      ...
                                      double amt4 = 0;
                                      for (int index = 0;
                                          index < addCropList.length;
                                          index++) {
                                        double? mainAmount = double.parse(
                                            '${addCropList[index].acreAmount}');

                                        amt1 = amt1 +
                                            (((double.parse(addCropList[index]
                                                                .acreAmount!) *
                                                            double.parse(addCropList[index]
                                                                .areaInAcre.toString()) *
                                                            double.parse(
                            ...
                            }, listener: (BuildContext context, IncompleteLoanCubitModel state) {
