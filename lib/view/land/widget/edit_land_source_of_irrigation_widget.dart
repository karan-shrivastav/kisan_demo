...
class EditLandSourceOfIrrigation extends StatefulWidget {
  const EditLandSourceOfIrrigation({super.key});

  @override
  State<EditLandSourceOfIrrigation> createState() => _EditLandSourceOfIrrigationState();
}

class _EditLandSourceOfIrrigationState extends State<EditLandSourceOfIrrigation> {
  ...
  void didChangeDependencies() {
    ...
    _sourceOfIrrigationController.text = editLandCubit.sourceOfIrrigationNAme ?? '';
